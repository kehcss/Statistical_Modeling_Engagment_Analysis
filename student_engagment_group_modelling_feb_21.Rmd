...
seda_mth <- seda_mth %>% filter(unique_session_IDs_count >= 5)
...
model_01 <- lmer(Slope ~ student_group_talkmove_ratio_w +
...
model_03 <- lmer(Slope ~ tutor_talkmove_ratio_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = TRUE, control = lmerControl(optimizer = "bobyqa"))
```
...
tab_model(model_01, model_011, model_03,  dv.labels = c("Student Group TalkMove", "Roboust Student Group TalkMove", "Tutor Talkmove"))
```

```{r}
#Adding Talkmove Predictors 04
model_04 <- blmer(Slope ~ student_group_talkmove_ratio_w + tutor_talkmove_ratio_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = TRUE, control = lmerControl(optimizer = "bobyqa"))
tab_model(model_04)
...
model_20 <- blmer(Slope ~ student_group_utterance_ratio_w +
              (1 | student_tutor_group),
...
model_24 <- blmer(Slope ~ student_group_utterance_ratio_w + tutor_utterance_ratio_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
tab_model(model_24)
```
...
model_30 <- blmer(Slope ~ student_group_relating_ratio_w +
              (1  | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
...
model_31 <- blmer(Slope ~ student_group_asking_for_info_ratio_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
...
model_32 <- blmer(Slope ~ student_group_making_claim_ratio_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
...
```{r}
#Adding Individual Talkmove Predictors 32
model_33 <- blmer(Slope ~ student_group_providing_evidence_ratio_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
...
```{r}
#Adding Individual Talkmove Predictors 31
model_3167 <- blmer(Slope ~ student_group_asking_for_info_ratio +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
...
model_40 <- blmer(Slope ~ tutor_keeping_together_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
```
...
model_41 <- blmer(Slope ~ tutor_students_relating_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
```
...
model_42 <- blmer(Slope ~ tutor_restating_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
```
...
model_43 <- blmer(Slope ~ tutor_revoicing_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
```
...
model_44 <- blmer(Slope ~ tutor_reasoning_w +
              (1 | student_tutor_group),
              data = seda_mth, REML = FALSE, control = lmerControl(optimizer = "bobyqa"))
```

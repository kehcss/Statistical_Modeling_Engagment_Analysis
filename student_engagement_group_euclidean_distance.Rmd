...
```{r}
seda <- read.csv(file = "march_26_group_var_euclince_modelling_student_talkmove_old_achievement_survey_merged.csv")
...
model_01 <- lmer(Slope ~ student_group_asking_for_info_ratio_w + unique_session_IDs_count +
